      ...
      bloc: context.read<SeatsCubit>()..getAllList(tripModel:context.read<ResultSearchCubit>().selectedTripModel! ),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                ImageWidget(url:AppImages.whiteSeatImage,height: 32,width: 32,fit: BoxFit.fill,).buildAssetSvgImage(),
            ...
            Row(
              children: [
                ImageWidget(url:AppImages.yellowSeatImage,height: 32,width: 32,fit: BoxFit.fill,).buildAssetSvgImage(),
                 const SizedBox(width: 7,),
            ...
            Row(
              children: [
                ImageWidget(url:AppImages.greySeatImage,height: 32,width: 32,fit: BoxFit.fill,).buildAssetSvgImage(),
                 const SizedBox(width: 7,),
            ...
            Row(
              children: [
                ImageWidget(url:AppImages.greenSeatImage,height: 32,width: 32,fit: BoxFit.fill,).buildAssetSvgImage(),
                const SizedBox(width: 7,),
            ...
            Row(
              children: [
                ImageWidget(url:AppImages.inUseSeatIcon,height: 32,width: 32,fit: BoxFit.fill,).buildAssetSvgImage(),
                const SizedBox(width: 7,),
            ...
            Row(
              children: [
                ImageWidget(url: AppImages.whiteSeatImage,height: 32,width: 32,).buildAssetSvgImage(),
                const SizedBox(width: 7,),
