...
class VipSeatsInfoScreen extends StatefulWidget {
  const VipSeatsInfoScreen({Key? key}) : super(key: key);

  @override
  State<VipSeatsInfoScreen> createState() => _VipSeatsInfoScreenState();
}

class _VipSeatsInfoScreenState extends State<VipSeatsInfoScreen> {
  @override
  void initState() {
    super.initState();
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: ListView.separated(
                                            ...
                                            shrinkWrap: true,
                                            itemBuilder: (context, index) => VipRowSeatWidget(index:index),
